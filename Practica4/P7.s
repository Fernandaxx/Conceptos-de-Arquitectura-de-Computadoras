...
num:	.word 4
	...
	; set registros
	ld r1, tabla(r0) 	; r1 guarda valores de la tabla
	dadd r2, r0, r0 	; r2 guarda el indice, inicia en 0 y aumenta en 8
	ld r3, num(r0)		; r3 guarda valor x
	dadd r4, r0, r0		; r4 guarda 1 si el valor de la tabla es mayor a x
	dadd r5, r0, r0		; r5 guarda cant
	ld r6, tablaLength(r0) 	; r6 es contador, de 10 a 0

loop:	ld r1, tabla(r2)	; guardo en r1 el valor a analizar

	slt r4, r3, r1		; guarda 1 en r4 si el valor de la tabla es estrictamente mayor que r3 (r3 < r1)
	sd r4, res(r2)                  ; guardo 1 en res cuando el valor de la tabla es mayor a x
	...
	sd r5, cant(r0)		; guardo cant en memoria
